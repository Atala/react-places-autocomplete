...
var PlacesAutocomplete = function (_Component) {
  ...
  function PlacesAutocomplete(props) {
    ...
    _this.onSearchCallback = _this.onSearchCallback.bind(_this);
    return _this;
  }
  ...
  _createClass(PlacesAutocomplete, [{
    ...
    value: function autocompleteCallback(predictions, status) {
      ...
      var formattedResults = predictions.map(function (p, idx) {
        return {
    ...
    value: function onSearchCallback(results) {
    ...
    value: function getActiveItem() {
      return this.state.results.find(function (item) {
        return item.active;
      });
    }
  }, {
    ...
    value: function selectActiveItemAtIndex(index) {
      var activeName = this.state.results[index].suggestion;
    ...
    value: function handleDownKey() {
      ...
      if (activeItem === undefined) {
        ...
        var currentIndex = this.state.results.indexOf(activeItem);
        var nextIndex = (currentIndex + 1) % this.state.results.length;
    ...
    value: function setActiveItemAtIndex(index) {
      this.setState({
        results: this.state.results.map(function (item, idx) {
          if (idx === index) {
            ...
            return _react2.default.createElement(
              'div',
              {
                ...
                onMouseOver: function onMouseOver() {
                  return _this3.setActiveItemAtIndex(idx);
                },
              ...
              _this3.props.autocompleteItem(p)
            );
          }),
